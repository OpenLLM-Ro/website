...
export const NewsBulletin = () => (
  <Stack padding={['8vh 10vw']}>
    ...
    <News link={'https://github.com/OpenLLM-Ro/FastChat'}>
      26.08.2024 - released the code & data (RoMTBench and RoCulturaBench) for evaluating Romanian
      LLMs using LLM-as-a-Judge
    </News>
    ...
    <News link={'https://github.com/OpenLLM-Ro/lm-evaluation-harness'}>
      09.08.2024 - released the code & data for evaluating Romanian LLMs on academic benchmarks and
      downstream tasks
    </News>
